...
<div class="hdr">
<h1 id="dash-title"><span>&#9670;</span> TINDERBOX</h1>
...
<script>
var A='/api';
var RESOURCE='experiments';
var TITLE_FIELD='name';

var fields=[{"name": "id", "label": "Id", "type": "text"}, {"name": "name", "label": "Name", "type": "text"}, {"name": "hypothesis", "label": "Hypothesis", "type": "text"}, {"name": "variant_a", "label": "Variant A", "type": "text"}, {"name": "variant_b", "label": "Variant B", "type": "text"}, {"name": "traffic_pct", "label": "Traffic Pct", "type": "integer"}, {"name": "status", "label": "Status", "type": "text"}, {"name": "winner", "label": "Winner", "type": "text"}, {"name": "created_at", "label": "Created At", "type": "text"}];
